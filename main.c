...
int interactiontype = 1; ///< The model to be used when a neutron hits a material boundary; choose between specular, diffuse(Lambert) or MicroRoughness
...
int main(int argc, char **argv){
	...
	/*for (vector<solid>::iterator i = geom.solids.begin(); i != solids.end(); ++i)
	            {
	                geom.solids[i].mat.ComputeMicroRoughnessTables();
	            }*/
