...
MicroRoughnessHelper* MicroRoughnessHelper::fpInstance = 0;

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

// Constructor

MicroRoughnessHelper::MicroRoughnessHelper() {;}
...
MicroRoughnessHelper* MicroRoughnessHelper::GetInstance()
{
  if (fpInstance == 0) fpInstance = new MicroRoughnessHelper;
  return fpInstance;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

double MicroRoughnessHelper::S2(double costheta2, double klk2)
{
...
double MicroRoughnessHelper::SS2(double costhetas2, double klks2)
{
...
double MicroRoughnessHelper::Fmu(double k2, double thetai,
...
double MicroRoughnessHelper::FmuS(double k, double kS,
...
double MicroRoughnessHelper::IntIplus(double E, double fermipot,
                                             double theta_i, int AngNoTheta,
                                             int AngNoPhi, double b2,
                                             double w2, double* max,
                                             double AngCut)
{
  *max=0.;
...
double MicroRoughnessHelper::IntIminus(double E, double fermipot,
                                              double theta_i,
                                              int AngNoTheta,
                                              int AngNoPhi, double b2,
                                              double w2, double* max,
                                              double AngCut)
{
  ...
  *max = 0.;
  ...
  if (E*cos(theta_i)*cos(theta_i) < fermipot) return wkeit;
...
double MicroRoughnessHelper::ProbIplus(double E, double fermipot,
                                              double theta_i,
                                              double theta_o,
                                              double phi_o,
                                              double b, double w,
...
double MicroRoughnessHelper::ProbIminus(double E, double fermipot,
                                               double theta_i,
                                               double thetas_o,
